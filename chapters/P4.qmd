...
## 10. 完整案例：MCP：纯标准库 Server + 动态工具发现 {#sec-P4-case}

完整脚本位于 `code/P4_mcp_minimal.py`。单文件双模式：`python P4_mcp_minimal.py server` 手工调试协议，`python P4_mcp_minimal.py agent "任务"` 跑完整 agent 流程。
